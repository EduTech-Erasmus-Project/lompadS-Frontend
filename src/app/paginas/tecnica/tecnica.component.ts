...
export class TecnicaComponent implements OnInit {
  ...
  // Listas predefinidas
  orCompositeTypeOptions: any[];
  orCompositeTypeSelected: string;

  operativeSystemOptions: any[];
  browserOptions: any[];

  orCompositeNameOptions: any[];
  orCompositeNameSelected: string;
  ...
  changeOrCompositeTypeOptions(type: any) {
    if (type == 'operating system') {
      this.orCompositeNameOptions = this.operativeSystemOptions;
    } else {
      this.orCompositeNameOptions = this.browserOptions;
    }
  }
